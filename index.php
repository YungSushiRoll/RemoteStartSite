...
<head>
    ...
    <title>Missouri Auto Electrical Systems</title>
    <link rel="icon" type="image/jpg" href="images/favicon.ico"/>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Asap&family=Montserrat:wght@500&family=Orbitron&display=swap" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/617087d686aee40a5737963f/1fifp57hm';
        s1.charset='UTF-8';
    ...
    <style>
        ...
        .itemDesc {
            font-size: 20px; font-family: 'Asap', sans-serif;
        }
        .testFont1{
...
<body style="background-color: lightgrey;">
    ...
    <div class="container">
            ...
            <div class="container rounded pt-3 mb-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-9 btnDiv">
                        ...
                        <div class="row">
                            <button style="font-family: Orbitron;" class="btn btn-secondary w-auto mb-3 ms-2" type="button" data-bs-toggle="collapse" data-bs-target="#oneWayDetail" aria-expanded="false" aria-controls="oneWayDetail">
            ...
            <div class="container rounded pt-3 mb-3 bg-white">                
                <div class="row">
                    ...
                    <div class="col-9 btnDiv">                        
                        ...
                        <div class="row">
                            <button style="font-family: Orbitron;" class="btn btn-secondary w-auto mb-3 ms-2" type="button" data-bs-toggle="collapse" data-bs-target="#twoWayDetail" aria-expanded="false" aria-controls="twoWayDetail">
                                &darr; KEY FEATURES AND SPECIFICATIONS &darr;
                            </button>
                        </div>  
                    </div>
            ...
            <div class="container rounded pt-3 mb-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-9 btnDiv">
                        ...
                        <div class="row">  
                            <button style="font-family: Orbitron;" class="btn btn-secondary w-auto mb-3 ms-2" type="button" data-bs-toggle="collapse" data-bs-target="#oneWayRemote" aria-expanded="false" aria-controls="oneWayRemote">
                                &darr; KEY FEATURES AND SPECIFICATIONS &darr;
                            </button>
                        </div> 
                    </div>
            ...
            <div class="container rounded pt-3 mb-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-9 btnDiv">
                        ...
                        <div class="row">
                            <button style="font-family: Orbitron;" class="btn btn-secondary w-auto mb-3 ms-2" type="button" data-bs-toggle="collapse" data-bs-target="#twoWayRemote" aria-expanded="false" aria-controls="twoWayRemote">
                                &darr; KEY FEATURES AND SPECIFICATIONS &darr;
                            </button>
                        </div>
                    </div>
            ...
            <div class="container rounded pt-3 mb-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-9 btnDiv">
                        ...
                        <div class="row">
                            <button style="font-family: Orbitron;" class="btn btn-secondary w-auto mb-3 ms-2" type="button" data-bs-toggle="collapse" data-bs-target="#combo" aria-expanded="false" aria-controls="combo">
                                &darr; KEY FEATURES AND SPECIFICATIONS &darr;
                            </button>
                        </div>
                    </div>
        ...
        <div>
            ...
            <div class="container rounded pt-3 mb-3 bg-white" style="height: 150px;">
                <div class="row pb-3 w-100 h-auto">
                    <div class="col-1 loc"></div>
                    <div class="col-3 loc">
